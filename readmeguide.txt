If you are stuck as to what to include as answers, below is a guide to help create your README.md file:
...
##Tests
List any tests that have been performed. You may want to go the extra mile and write tests for your application. Then provide examples on how to run them here.

##Credits
List your collaborators, if any, with links to their GitHub profiles. If you used any third-party assets that require attribution, list the creators with links to their primary web presence in this section. If you used tutorials, include links to those here as well.
